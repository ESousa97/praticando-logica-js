...
<p align="center">
  <a href="https://praticando-logica-js.vercel.app/" target="_blank" rel="noopener noreferrer">
    <img src="https://img.shields.io/badge/🚀%20Acessar%20Plataforma-000000?style=for-the-badge&logo=vercel&logoColor=white" alt="Acessar Plataforma">
  </a>
</p>
...
[![Licença MIT](https://img.shields.io/github/license/ESousa97/praticando-logica-js?style=for-the-badge&label=Licença)](https://github.com/ESousa97/praticando-logica-js/blob/main/LICENSE)
[![Linguagem Principal](https://img.shields.io/github/languages/top/ESousa97/praticando-logica-js?style=for-the-badge&label=Linguagem%20Principal)](https://github.com/ESousa97/praticando-logica-js)
[![Último Commit](https://img.shields.io/github/last-commit/ESousa97/praticando-logica-js?style=for-the-badge&label=Último%20Commit)](https://github.com/ESousa97/praticando-logica-js/commits/main)
[![Issues Abertas](https://img.shields.io/github/issues/ESousa97/praticando-logica-js?style=for-the-badge&label=Issues)](https://github.com/ESousa97/praticando-logica-js/issues)
[![Pull Requests](https://img.shields.io/github/issues-pr/ESousa97/praticando-logica-js?style=for-the-badge&label=Pull%20Requests)](https://github.com/ESousa97/praticando-logica-js/pulls)
[![Tamanho do Código](https://img.shields.io/github/repo-size/ESousa97/praticando-logica-js?style=for-the-badge&label=Tamanho%20do%20Código)](https://github.com/ESousa97/praticando-logica-js)
[![Contribuidores](https://img.shields.io/github/contributors/ESousa97/praticando-logica-js?style=for-the-badge&label=Contribuidores)](https://github.com/ESousa97/praticando-logica-js/graphs/contributors)
...
<p align="center">
  <img src="./assets/praticando-logica-js.gif" alt="Demonstração da Plataforma de Exercícios" width="800">
</p>
...
```mermaid
graph TB
    subgraph "Camada de Apresentação (Vue.js 3 SPA)"
        A[Usuário via Browser] --> B[Vue.js App Shell]
        B --> C[Vue Router]
        C --> D[Home View]
        C --> E[Modules View]
        E --> F[Exercise Categories]
        F --> G[Exercise Navigation]
    end
    
    subgraph "Camada de Conteúdo (Vanilla JS)"
        H[Sorteador de Números<br/>DOM Manipulation]
        I[AluGames<br/>Event Handling]
        J[Carrinho de Compras<br/>Data Processing]
        K[Amigo Secreto<br/>Algorithm Logic]
        L[Ingresso Online<br/>Form Validation]
        M[Desafios Finais<br/>Problem Solving]
    end
    
    subgraph "State Management"
        N[Pinia Store<br/>User Progress]
        O[Exercise Metadata<br/>Static Data]
    end
    
    subgraph "Deploy Infrastructure (Vercel)"
        P[Main SPA Deploy<br/>Central Portal]
        Q[Exercise Deploy 1<br/>Independent URL]
        R[Exercise Deploy 2<br/>Independent URL]
        S[Exercise Deploy N<br/>Independent URL]
    end
...
<p align="center">
  <img src="https://img.shields.io/github/stars/ESousa97/praticando-logica-js?style=social" alt="GitHub Stars" />
  <img src="https://img.shields.io/github/forks/ESousa97/praticando-logica-js?style=social" alt="GitHub Forks" />
</p>
