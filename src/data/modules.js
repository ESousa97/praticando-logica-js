    ...
    lessons: [
      {
        ...
        theory:
          'Vamos começar escrevendo nosso primeiro comando em JavaScript! O console.log é usado para mostrar mensagens no console do navegador.',
        exercise: {
          type: 'code',
      ...
      },
      {
        ...
        title: 'Variáveis',
        theory:
          'Variáveis servem para guardar valores. Você pode criar com let, const ou var. Use let para valores que podem mudar e const para valores fixos.',
        exercise: {
          type: 'code',
      ...
      },
      {
        ...
        theory:
          'Podemos fazer operações matemáticas com variáveis numéricas. O operador + é usado para somar valores.',
        exercise: {
          type: 'code',
    ...
    lessons: [
      {
        ...
        title: 'If e Else',
        theory:
          'Com if/else, você toma decisões no seu código. Se uma condição for verdadeira, executa um bloco, senão executa outro.',
        exercise: {
          type: 'code',
          question:
            "Verifique se uma idade é maior ou igual a 18 e mostre 'Maior de idade' ou 'Menor de idade'.",
          placeholder:
      ...
      },
      {
        ...
        title: 'Listas e For',
        theory:
          'Arrays (listas) guardam vários valores. O loop for percorre cada item da lista permitindo executar ações em todos os elementos.',
        exercise: {
          type: 'code',
    ...
    lessons: [
      {
        ...
        theory:
          'Com JavaScript, você pode alterar elementos da página web. O DOM permite selecionar elementos e modificar seu conteúdo.',
        exercise: {
          type: 'code',
      ...
      },
      {
        ...
        theory:
          'Funções são blocos de código reutilizáveis. Podem receber parâmetros (dados) para trabalhar e retornar resultados.',
        exercise: {
          type: 'code',
    ...
    lessons: [
      {
        ...
        theory:
          'Vamos criar um jogo interativo! O usuário tentará adivinhar um número aleatório de 1 a 10. Isso combina vários conceitos aprendidos.',
        exercise: {
          type: 'code',
          question:
      ...
      },
      {
        ...
        theory:
          'Depois de criar seus projetos, é hora de compartilhá-los! Existem várias plataformas gratuitas para hospedar sites.',
        exercise: {
          type: 'text',
